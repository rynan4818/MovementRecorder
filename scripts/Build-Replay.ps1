...
if ($Package) {
    ...
    Copy-Item -LiteralPath (Join-Path $repo 'docs\Replay-ja.md'), (Join-Path $repo 'docs\Replay-Implementation-ja.md'),
        ...
        (Join-Path $repo 'docs\Replay-Menu-Source-Visibility-ja.md'),
        (Join-Path $repo 'docs\Replay-Menu-Row-Fix-ja.md'),
        (Join-Path $repo 'docs\Replay-Camera2-Integration-ja.md'),
        (Join-Path $repo 'docs\Replay-Camera2-Integration-Plan-ja.md'),
        (Join-Path $repo 'docs\Replay-Source-Avatar-Offset-ja.md'),
        (Join-Path $repo 'docs\Replay-Source-Avatar-Offset-Plan-ja.md'),
        (Join-Path $repo 'docs\Replay-Source-Avatar-Offset-Plan-v2-ja.md'),
        (Join-Path $repo 'docs\Replay-Offset-Step-01m-ja.md'),
        (Join-Path $repo 'docs\Replay-Menu-Source-Visibility-Plan-ja.md'),
